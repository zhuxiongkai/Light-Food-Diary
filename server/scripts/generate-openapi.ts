  ...
  components: {
    ...
    schemas: {
      ...
      AiResult: {
        type: 'object',
        properties: {
          name: { type: 'string', example: '番茄炒蛋' },
          confidence: { type: 'number', example: 0.92 },
          caloriesPer100g: { type: 'number', example: 125 },
          protein: { type: 'number', example: 6.4 },
          fat: { type: 'number', example: 7.2 },
          carbs: { type: 'number', example: 8.5 },
        },
      },
    },
  },
            ...
            content: {
              'application/json': {
                ...
                example: {
                  code: 0,
                  data: [
                    { name: '番茄炒蛋', confidence: 0.92, caloriesPer100g: 125, protein: 6.4, fat: 7.2, carbs: 8.5 },
                    { name: '米饭', confidence: 0.88, caloriesPer100g: 116, protein: 2.6, fat: 0.3, carbs: 25.9 },
                  ],
                  message: 'ok',
                },
              },
